...
export default function ImgHome({ navLink, setNavLink }) {
  ...
  const Imgs = [home, calendario, estudos, tracking];

  return (
    <S.WrapperImgHome>
      <S.NavHome>
        <S.NavHomeItem
          className={navLink === 0 ? "active" : ""}
          onClick={() => setNavLink(0)}
        >
          <span>Bem Vindo</span>
        </S.NavHomeItem>
        <S.NavHomeItem
          className={navLink === 1 ? "active" : ""}
          onClick={() => setNavLink(1)}
        >
          <span>Cronograma</span>
        </S.NavHomeItem>
        <S.NavHomeItem
          className={navLink === 2 ? "active" : ""}
          onClick={() => setNavLink(2)}
        >
          <span>Estudos</span>
        </S.NavHomeItem>
        <S.NavHomeItem
          className={navLink === 3 ? "active" : ""}
          onClick={() => setNavLink(3)}
        >
          <span>Habitos</span>
        </S.NavHomeItem>
      </S.NavHome>
